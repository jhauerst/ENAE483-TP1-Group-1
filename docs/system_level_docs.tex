...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{./submission2_flowchart.png}
...
\newpage
\section{Code}
\lstinputlisting[language=matlab]{../src/Section2_1.m}
\lstinputlisting[language=matlab]{../src/EngineDimension.m}
\lstinputlisting[language=matlab]{../src/findFairingMass.m}
\lstinputlisting[language=matlab]{../src/findFuelMass.m}
\lstinputlisting[language=matlab]{../src/findInsulationMass.m}
\lstinputlisting[language=matlab]{../src/findTankHeight.m}
\lstinputlisting[language=matlab]{../src/findTankMass.m}
\lstinputlisting[language=matlab]{../src/findVolume.m}
\lstinputlisting[language=matlab]{../src/findWiringa_AvionicsMass.m}
\lstinputlisting[language=matlab]{../src/RocketDiameter.m}
\lstinputlisting[language=matlab]{../src/stageEngineMass.m}
\lstinputlisting[language=matlab]{../src/submission1.m}
\lstinputlisting[language=matlab]{../src/totalInertMass.m}
